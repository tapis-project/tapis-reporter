...
def trainings(request):
    if request.method == 'GET':
        logger.error(f'In {request.method} method of trainings')
...
def gateways(request):
    if request.method == 'GET':
        logger.error(f'In {request.method} method of gateways')
        ...
        try:
            ...
            logger.error(f"context sent to html: {context}")
...
def tenant_gateways(request, tenant):
    if request.method == 'GET':
        logger.error(f'In {request.method} method of tenant gateways')
...
def github(request):
    if request.method == 'GET':
        logger.error(f'In {request.method} method of github')
...
def papers(request):
    if request.method == 'GET':
        logger.error(f'In {request.method} method of papers')
...
def streams(request):
    if request.method == 'GET':
        logger.error(f'In {request.method} method of streams')
